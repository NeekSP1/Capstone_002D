...
urlpatterns = [
    ...
    path('aprobacion_confirmada/', views.aprobacion_confirmada, name='aprobacion_confirmada'),
    ...
    path('confirmacion_recuperacion/', views.confirmacion_recuperacion, name='confirmacion_recuperacion'),
    path('contactoClientes/', views.contactoClientes, name='contactoClientes'),
    path('contactoColaboradors/', views.contactoColaboradors, name='contactoColaboradors'),
    path('nosotrosClientes/', views.nosotrosClientes, name='nosotrosClientes'),
    path('nosotrosColaboradors/', views.nosotrosColaboradors, name='nosotrosColaboradors'),
    ...
    path('limpiar_pedidos/', views.limpiar_pedidos_confirmados, name='limpiar_pedidos_confirmados'),
    ...
    path('carrito/', views.carritobarbero, name='carritobarbero'),
